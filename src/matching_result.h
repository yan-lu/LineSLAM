...
class MatchingResult {
    public:
        ...
        std::vector<cv::DMatch> all_line_matches;
#endif        
    public:
...
class MatchingResult_Lines {
public:
  MatchingResult_Lines() :
    rmse(0.0), 
    ransac_trafo(Eigen::Matrix4f::Identity()), 
    final_trafo(Eigen::Matrix4f::Identity())    
  {
  ...
  Eigen::Matrix4f ransac_trafo;
  Eigen::Matrix4f final_trafo;
  unsigned int inlier_number, outlier_number, occluded_number, all_number;
public:
      EIGEN_MAKE_ALIGNED_OPERATOR_NEW
};
