...
bool RosUi::services(lineslam::lineslam_ros_ui::Request  &req,
                     lineslam::lineslam_ros_ui::Response &res )
{
...
bool RosUi::services_b(lineslam::lineslam_ros_ui_b::Request  &req,
                       lineslam::lineslam_ros_ui_b::Response &res )
{
...
bool RosUi::services_s(lineslam::lineslam_ros_ui_s::Request  &req,
                       lineslam::lineslam_ros_ui_s::Response &res )
{
...
bool RosUi::services_f(lineslam::lineslam_ros_ui_f::Request  &req,
                       lineslam::lineslam_ros_ui_f::Response &res )
{
    ROS_INFO_STREAM("Got Service Request. Command: " << req.command << ". Value: " << req.value );
