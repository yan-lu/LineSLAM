      ...
      external_renderable(NULL) 
{
  ...
  //  bg_col_[0] = bg_col_[1] = bg_col_[2] = bg_col_[3] = 0.01;//almost black background (almost, so that the see-through rendering bug on my pc doesn't occur
    bg_col_[0] = bg_col_[1] = bg_col_[2] = bg_col_[3] = 1-0.01;
    ...
    this->renderText(0,0,0, "LineSLAM", QFont("Monospace", 14));  // ylu: rand seed 
...
void GLViewer::paintGL() {
    ...
    if(cloud_matrices->size() == 0){
      glColor4f(1,0,0,1);    
      this->renderText(-0.34,0.1,1, QString("L"),   QFont("Serif", 28, QFont::Bold, false));
      glColor4f(0,1,0,1);    
      this->renderText(-0.25,0.1,1, QString("i"),   QFont("Serif", 28, QFont::Bold, false));
      glColor4f(0,0,1,1);    
      this->renderText(-0.18,0.1,1, QString("n"),   QFont("Serif", 28, QFont::Bold, false));
      glColor4f(.5,.5,.5,1); 
      this->renderText(-0.09,0.1,1, QString("e"),   QFont("Serif", 28, QFont::Bold, false));
