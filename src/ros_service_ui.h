...
#include <QObject>
#include "lineslam/lineslam_ros_ui.h"
#include "lineslam/lineslam_ros_ui_b.h"
#include "lineslam/lineslam_ros_ui_f.h"
#include "lineslam/lineslam_ros_ui_s.h"
...
public:
    ...
    bool services(lineslam::lineslam_ros_ui::Request  &req, lineslam::lineslam_ros_ui::Response &res);
    ///a service-client for all methods with bool as argument: {pause, record}
    bool services_b(lineslam::lineslam_ros_ui_b::Request  &req, lineslam::lineslam_ros_ui_b::Response &res);
    ///a service-client for floats, e.g., for changing the maximal depth of a point: {set_max}
    bool services_f(lineslam::lineslam_ros_ui_f::Request  &req, lineslam::lineslam_ros_ui_f::Response &res);
    ///a service-client for commands with string arguments, e.g. a filename
    bool services_s(lineslam::lineslam_ros_ui_s::Request  &req, lineslam::lineslam_ros_ui_s::Response &res);
Q_SIGNALS:
