...
#ifdef USE_LINES
  ///// 2d line 
  addOption("lsd_angle_thres",               static_cast<double> (22.5),                "angle threshold for LSD (line segment detector)");
  addOption("lsd_density_thres",             static_cast<double> (0.7),                 "density threshold for LSD (line segment detector)");
  addOption("line_2d_len_thres",             static_cast<double> (10),                  "2d line segment length threshold");
  addOption("line_detect_algorithm",         std::string("LSD"),                       "");
  addOption("msld_sample_interval",          static_cast<double> (1),                   "MSLD sample point interval");

  ///// 3d line
  addOption("line_3d_len_thres_m",           static_cast<double> (0.02),                "3d line segment length threshold, in meter");
  addOption("collin_pts_ratio",              static_cast<double> (0.6),                 "ratio deciding if a frameline has enough collinear 3d pts");
  addOption("line_sample_max_num",           static_cast<int> (100),                     "max number of sample points from a line, 100 => 50, OK");
  addOption("line_sample_min_num",           static_cast<int> (10),                     "min number of sample points from a line");
  addOption("line_sample_interval",          static_cast<double> (1),                   "interval between two sample points from a line");
  addOption("line3d_mle_iter_num",           static_cast<int> (100),                     "max iteration number for MLE of 3d line ");         
  addOption("3d_pt2line_dst_extline_m",      static_cast<double> (0.02),                "3d pt to 3d line distance threshold when detecting lines from pts");
  addOption("3d_pt2line_mahdst_extline",     static_cast<double> (1.5),                 "3d pt to 3d line mahalanobis distance threshold when detecting lines from pts");
  addOption("ransac_iters_extline",          static_cast<int> (100),                     "max iter numbers of ransac when extract line from 3d points"); 
  addOption("n_cell_lineseg_range",          static_cast<int> (10),                     "devide a line segment into n subsegments/cells");
  addOption("pts_ratio_verify_3dline",       static_cast<double>(0.7),                  "pts on line ratio when verifying a detected 3d line");
  
  ///// camera model
  addOption("sample_pt_std_imgline",         static_cast<double>(3),                    "std dev of sample points from an image line");
  addOption("depth_std_coeff_c1",            static_cast<double>(0.00273),              "coefficients of a quadratic model for depth sensor noise");
  addOption("depth_std_coeff_c2",            static_cast<double>(0.00074),              "coefficients of a quadratic model for depth sensor noise");
  addOption("depth_std_coeff_c3",            static_cast<double>(-0.00058),             "coefficients of a quadratic model for depth sensor noise");
  
  ///// relative motion
  addOption("3d_pt2line_dst_relmot_m",       static_cast<double>(0.05),                 "in relative motion estimation");
  addOption("3d_line_angle_relmot_deg",      static_cast<double>(10),                   "in relative motion estimation");
  addOption("ransac_iters_line_motion",      static_cast<int> (500),                     "");
  addOption("adjacent_linematch_window",     static_cast<int> (3),                      "raw frames within this window are considered as line matching between adjacent frames");
  addOption("adjust_img_bright",             static_cast<bool> (false),                 "adjust image brightness or not, using e.g. histeq");
  addOption("max_mah_dist_for_inliers",      static_cast<double>(3),                    "mahalanobis distance threshold for ransac inliers");
  addOption("g2o_line_error_weight",          static_cast<double>(1),                    "weight relative to point errors");
  ///// misc
  addOption("clear_past_point_cloud",        static_cast<bool> (true),                 "to save memory, Remove the point cloud data of nodes. only keep pc for relative motion of current frame");
  addOption("line_match_number_weight",      static_cast<int> (1),                      "when counting feature matches, line plays different than point");  
  addOption("min_matches_loopclose",         static_cast<int> (20),                       "for detecting loop closure, min numb of matches");         
#endif

#ifdef ALLOW_LOAD_RAWDATA
  addOption("raw_data_directory_name",       std::string(""),                            "load from a directory consisting of color and dpeth images");
  addOption("raw_data_dir_list_file",        std::string(""),                             "");
#endif  
