...
class OpenNIListener : public QObject {
  ...
  public:
    ...
    void loadRawData(std::string dirname, bool alone=true); // raw images
    void loadRawDataFromGUI (QString);
    void loadRawDataList(std::string filename);
    void loadRawDataListFromGUI(std::string);
#endif 
