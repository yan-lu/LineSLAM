/* This file is part of LineSLAM.
 * 
 * LineSLAM is free software: you can redistribute it and/or modify
 * it under the terms of the GNU General Public License as published by
 * the Free Software Foundation, either version 3 of the License, or
 * (at your option) any later version.
 * 
 * LineSLAM is distributed in the hope that it will be useful,
 * but WITHOUT ANY WARRANTY; without even the implied warranty of
 * MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the
 * GNU General Public License for more details.
 * 
 * You should have received a copy of the GNU General Public License
 * along with LineSLAM.  If not, see <http://www.gnu.org/licenses/>.
 */
...
///Constructs a QT GUI for easy control of LineSLAM
Graphical_UI::Graphical_UI() : filename("quicksave.pcd"), glviewer(NULL)
{
  setup();
  setWindowTitle(tr("LineSLAM"));
}
///Constructs a QT GUI for easy control of LineSLAM
...
void Graphical_UI::setup(){
    infoText = new QString(tr( // todo: modify info
                "<p><b>LineSLAM</b> uses visual features to identify corresponding 3D locations "
    ...
    licenseText = new QString(tr(
                 "<p>LineSLAM is free software: you can redistribute it and/or modify"
                 "it under the terms of the GNU General Public License as published by"
                 "the Free Software Foundation, either version 3 of the License, or"
                 "(at your option) any later version.</p>"
                 "<p>LineSLAM is distributed in the hope that it will be useful,"
                 "but WITHOUT ANY WARRANTY; without even the implied warranty of"
                 "MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE.  See the"
                 "GNU General Public License for more details.</p>"
                 "<p>You should have received a copy of the GNU General Public License"
                 "along with LineSLAM.  If not, refer to <a href=\"http://www.gnu.org/licenses/\">http://www.gnu.org/licenses</a>.</p>"));
    ...
    QString message = tr("Ready for LineSLAM");
...
void Graphical_UI::toggleScreencast(bool on) {
  if(on){
    QString myfilename = QFileDialog::getSaveFileName(this, "Path Prefix for Screencast Frames", "LineSLAM_frame_", tr("All Files (*.*)"));
    if(myfilename.size() > 0){
...
void Graphical_UI::about() {
    QMessageBox::about(this, tr("About LineSLAM"), *infoText + *licenseText);
}
...
void Graphical_UI::createMenus() {
    ...
    */
    ...
    QAction *aboutAct = new QAction(tr("&About LineSLAM"), this);
    aboutAct->setShortcut(QString("Ctrl+A"));
    aboutAct->setStatusTip(tr("Show information about LineSLAM"));
...
void Graphical_UI::showOptions(){
  ...
  QLabel* intro = new QLabel("<h3>This is an read-only view of the current settings. To modify LineSLAM's settings use the ROS parameter server functionality (i.e. set options either in a launch-file or as a command line parameter).</h3>");
